Feature: User On-Boarding Flow
  ...
  Scenario Outline: Verify the Buyer On-boarding Flow
    ...
    And verify Dealcirege icon <TestMsg>
    ...
    Examples:
     ...
     # | pegasusuiadvisor@gmail.com  | pegasusapprover@gmail.com         | Test@1234     |BUYER     | TestBuyer  | Automation  | QA Automation | PegasusAutomation | TEST1234  | 80091988  | TestAccount | Add this user in GCC to make it ready for Automation
      #https://scvpegasus.atlassian.net/wiki/spaces/PEG/pages/691634187/Buyer+Seller+Email+Setup